...
class Blockchain {
    ...
    // this will create first empty block
    createGenesisBlock() {
        return new Block("18/10/2021", "Genesis block", "0")
    }
    // this function will get the last block
    getLatestBlock() {
        return this.chain[this.chain.length - 1];
    }

    // this function is to add new block to the chain
    ...
    // this function validate the blockchain
